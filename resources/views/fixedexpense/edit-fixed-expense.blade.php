...
<body>
    <div class="min-h-screen bg-page-custom">
        ...
        <main class="container mx-auto p-4">
            <form method="POST" action="{{ route('fixedexpenses.update', $fixedexpense->id) }}">
                @csrf
                @method('PUT')
                    ...
                    <div class="p-2 bg-white shadow-md rounded-md">
                        <div class="mt-4">
                            <label for="name_fixed_expense" class="block mb-2">
                                ...
                                <input 
                                    id="name_fixed_expense" 
                                    name="name_fixed_expense" 
                                    type="text" 
                                    value="{{ $fixedexpense->input_name }}"
                        ...
                        <div class="mt-4">
                            <label for="value_fixed_expense" class="block mb-2">
                                ...
                                <input 
                                    id="value_fixed_expense" 
                                    name="value_fixed_expense" 
                                    type="number" 
                ...
                <div class="container mx-auto p-4">
                    <div class="w-full md:w-5/6 mx-auto">
                        <section class="flex justify-between">
                            <a href="{{ route('fixedexpenses.index') }}" id="back-button">
                                <x-button-add>
                                    Volver
                                </x-button-add>
                            </a>
