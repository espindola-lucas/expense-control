        ...
        <div class="h-screen flex">
            <div class="hidden sm-500:flex w-1/2 bg-gradient-to-tr from-blue-800 to-purple-700 justify-around items-center md:flex">
                <div>
                    ...
                    <!-- <button type="submit" class="block w-28 bg-white text-indigo-800 mt-4 py-2 font-bold mb-2">Read More</button> -->
                    <div class="mb-4">
            ...
            <div class="flex w-full sm-500:w-1/2 justify-center items-center bg-semi-white">
                <form class="bg-white text-center mt-6 px-6 py-4 shadow-md sm:rounded-lg">
                    ...
                    <div class="mb-4">
                        <a class="group relative inline-block overflow-hidden border border-indigo-600 px-8 py-3 focus:outline-none focus:ring" href="{{ route('login') }}">
                    ...
                    <div class="mb-4">
                        <a class="group relative inline-block overflow-hidden border border-indigo-600 px-10 py-3 focus:outline-none focus:ring" href="{{ route('register') }}">
                            <span class="absolute inset-y-0 left-0 w-[2px] bg-indigo-600 transition-all group-hover:w-full group-active:bg-indigo-500"></span>
                            <span class="relative text-sm font-medium text-indigo-600 transition-colors group-hover:text-white">
                                Registrarse
                            </span>
        ...
        <!-- <div class="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50">
            ...
            <div class="relative min-h-screen flex flex-col items-center justify-center selection:bg-[#FF2D20] selection:text-white">
                <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                    ...
                    <a class="group relative inline-block overflow-hidden border border-indigo-600 px-8 py-3 focus:outline-none focus:ring" href="#">
                        <span class="absolute inset-y-0 left-0 w-[2px] bg-indigo-600 transition-all group-hover:w-full group-active:bg-indigo-500"></span>
                            <span class="relative text-sm font-medium text-indigo-600 transition-colors group-hover:text-white">
                                Iniciar Sesion
                            </span>
